                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{URL::to('vendor/create') }}" class="btn btn-tool"><i class="fa fa-plus"></i> Add</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" style="width: 100%;">
                                ...
                                @foreach($vendors as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->vendor_zipcode }}</td>
                                        <td>{{ $row->vendor_phone }}</td>
                                        <td>{{ $row->vendor_email }}</td>
                                        <td>{{ $row->vendor_status }}</td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{URL::to('vendor/show/'.$row->vendor_id)}}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                <a href="{{URL::to('vendor/'.$row->vendor_id.'/edit')}}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                <a href="#" class="btn btn-danger" onclick="deleteConfirm('{{ URL::to('vendor/delete/'.$row->vendor_id) }}', '{{ $row->vendor_name }}');"><i class="fa fa-trash"></i></a>    
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus Vendor <b><span id="show_name">bbcdbcndbc</span></b> ini?</p>
            </div>
