                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('trxtion_code', '', ['class' => 'form-control']) }}
                        </div>
                        <div class="form-group">
                            {{ Form::label('sold', 'Sold') }}
                            {{ Form::number('total_out_stock', '', ['class' => 'form-control']) }}
                        </div>

                        <div class="form-group">
                            {{ Form::label('date', 'Date') }}
                            {{ Form::date('trxtion_date', '', ['class' => 'form-control']) }}
                            <!-- {{ Form::input('dateTime-local', 'trxtion_date', '' , array('class' => 'form-control')) }} -->
                        </div>
