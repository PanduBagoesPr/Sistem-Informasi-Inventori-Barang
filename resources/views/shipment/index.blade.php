                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('shipment.create') }}" class="btn btn-tool"><i class="fa fa-plus"></i> Add</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" style="width: 100%;">
                                ...
                                @foreach($shipments as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->shipment_customer }}</td>
                                        <td>{{ $row->product->product_name }}</td>
                                        <td>{{ $row->shipment_address }}</td>
                                        <td>{{ $row->shipment_phone }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{ route('shipment.show', $row->shipment_id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('shipment.edit', $row->shipment_id) }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                <a href="#" class="btn btn-danger" onclick="deleteConfirm('{{ url('shipment/delete/'.$row->shipment_id) }}', '{{ $row->shipment_name }}');"><i class="fa fa-trash-alt"></i></a>    
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus shipment <b><span id="show_name"></span></b> ini?</p>
            </div>
