                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::select('vendor_id', $vendors, $product->vendor_id, ['class' => 'form-control', 'placeholder' => 'Choose One', 'disabled' => 'disabled']) }}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::number('total', $product->total, ['class' => 'form-control', 'placeholder' => 'Enter product price', 'disabled' => 'disabled']) }}
                                </div>
                                <div class="form-group">
